...
window.wheelzoom = (function(){
	...
	main = function(img, options){
		...
		function updateBgStyle() {
			...
			if(zoom_l >= 0){
				var index 	= zoom_l / settings.zoom;		
				index 		= index.toFixed(0);
				var img_ref = settings.img_level[index];
				img.style.backgroundImage = "url('" + img_ref + "')";		
			}
...
//			document.addEventListener('mouseup', removeDrag);
	...
	//		img.addEventListener('mousedown', function(){$("#villo").draggable();});
		}
